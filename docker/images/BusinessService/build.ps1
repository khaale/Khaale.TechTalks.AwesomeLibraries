...
$projectPath = "..\..\..\src\BusinessServiceCore"
...
&docker build -t khaale-awesome_libs-business_service .
&docker tag khaale-awesome_libs-business_service:latest khaale-awesome_libs-business_service:0.0.1
